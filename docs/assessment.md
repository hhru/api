...
> <img src="http://hhru.github.io/api/badges/emp_paid.png" alt="employer with paid access" /> : Для работодателя работа с инструментами оценки требует [наличия платного доступа](/docs/payable/employer_payable_methods.md)
