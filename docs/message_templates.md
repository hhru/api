...
использования в отправляемых соискателю приглашениях на вакансию или действиях
по откликам/приглашениям.
...
[списке топиков](employer_negotiations.md#negotiations-list)
...
* `404 Not Found` – исли использован несуществующий шаблон.
...
* `400 Bad Request` – не верные параметры запроса.
