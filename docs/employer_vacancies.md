...
* `403 Forbidden` – ошибка авторизации пользователя или недостаточно прав. Ожидается **работодатель**.
...
* `403 Forbidden` – ошибка авторизации пользователя. Ожидается **работодатель**.
* `404 Not Found` - вакансия с идентификатором `vacancy_id` не существует или у текущего менеджера нет прав на редактирование данной вакансии