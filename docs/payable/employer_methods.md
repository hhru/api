...
Проверить информацию о подключенных услугах работодателя можно с помощью [специального метода](/docs/employer_services.md#payable-api-actions).
...
> Разница между третьей и четвертой группой в текущем отношении между работодателем и запрашиваемым резюме. При наличии доступа к группе 3 - появляется возможность получения резюме находящихся в откликах / приглашениях на текущую активную вакансию работодателя. При наличии доступа к группе 4 - появляется возможность запрашивать [найденные в базе](/docs/resumes_search.md) резюме.
