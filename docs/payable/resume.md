...
Это значит, что для работодателей использующих доступ к базе данных с возможностью просмотра контактной информации, при просмотре резюме найденных из базы резюме, требуется явно открывать контактную информацию в каждом из них.
