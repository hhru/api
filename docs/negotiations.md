...
где:
 ...
 viewed_by_me | логический | Прочитано ли сообщение смотрящим (для сообщений отправеленных соискателем - всега `null`)
 viewed_by_opponent | логический | Прочитанно ли сообщение работодателем (для сообщений работодателя - `null`) 
