...
где:
 ...
 viewed_by_me | логический, null | Прочитано ли сообщение смотрящим (для сообщений отправеленных соискателем - всегда `null`)
 viewed_by_opponent | логический, null | Прочитанно ли сообщение работодателем (для сообщений работодателя - `null`) 
