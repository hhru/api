...
response_source | нет          | Источник отклика, он может играть роль например при отклике неполным резюме, отклик таким резюме будет разрешен только для определенных источников
