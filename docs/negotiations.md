...
* `403 Forbidden` – ошибка авторизации пользователя или отправка сообщения невозможна.
...
* `403 Forbidden` – ошибка авторизации пользователя или в случае, когда редактирование сообщения запрещено (Например, принимающая сторона уже успела прочитать сообщение).
