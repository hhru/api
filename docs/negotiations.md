...
> В данный момент функциональность откликов/приглашений реализована только для соискателей. Для работодателей данный сервис запланирован, но еще не выпущен. 
