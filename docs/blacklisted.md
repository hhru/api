...
`GET /employers/blacklisted` возвращает [подмножество работодателей](https://api.hh.ru/openapi/redoc#tag/Rabotodatel/paths/~1employers/get), скрытых пользователем.
