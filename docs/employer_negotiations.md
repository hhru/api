...
test_result | обьект, null | Результат [теста](https://api.hh.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/operation/get-negotiation-test-results) прикрепленного к вакансии
