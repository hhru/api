...
updated_after | нет | Выдавать отклики, обновленные или созданные начиная с заданного времени (включая переданное время). Пример запроса: `GET https://api.hh.ru/negotiations/invited?vacancy_id=123456&updated_after=2015-10-14T00:00:00+0300`
