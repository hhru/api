...
* `400 Bad Request` – ошибка в параметрах запроса.
* `403 Forbidden` – ошибка авторизации пользователя или приглашение невозможно.
...
* `403 Forbidden` – ошибка авторизации пользователя или действие по отклику невозможно.
