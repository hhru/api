...
-----------------------------|-----------------|-------------
 ...
 test.id                     | string          | [the test](https://api.hh.ru/openapi/en/redoc#tag/Employer-directories/paths/~1employers~1%7Bemployer_id%7D~1tests/get) that will be added to the vacancy
